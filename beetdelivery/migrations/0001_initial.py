# Generated by Django 4.2 on 2023-06-14 10:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='beetdelivery.year')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('station', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='beetdelivery.schedule')),
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='beetdelivery.year')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='beetdelivery.hill')),
                ('ratte', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='beetdelivery.ratte')),
            ],
        ),
        migrations.AddField(
            model_name='schedule',
            name='station',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='beetdelivery.station'),
        ),
        migrations.CreateModel(
            name='Manager',
            fields=[
